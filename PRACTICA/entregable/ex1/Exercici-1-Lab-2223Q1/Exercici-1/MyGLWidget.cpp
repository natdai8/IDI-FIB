...
void MyGLWidget::pintaNino()
{
  ...
  if (corona_si != 0 and corona_si <= 2)
  {
  ...
  if (corona_si == 2)
  {
    modelTransformBracEsquerre2();
    pintaBrac();

    modelTransformBracDret2();
    pintaBrac();
  }
...
{
  glm::mat4 TG(1.0f);
  TG = glm::translate(TG,glm::vec3(-0.15,0.15,0.0));
  TG = glm::scale(TG,glm::vec3(0.2,0.2,1.0));
...
void MyGLWidget::modelTransformBracDret2()
{
  glm::mat4 TG(1.0f);
  TG = glm::translate(TG,glm::vec3(-0.15,0.15,0.0));
  TG = glm::rotate(TG, glm::radians(-120.f), glm::vec3(0,0,1));
  TG = glm::scale(TG,glm::vec3(0.2,0.2,1.0));
  TG = glm::translate(TG,glm::vec3(0.0,-1.0,0.0));
  glUniformMatrix4fv(TGLoc, 1, GL_FALSE, &TG[0][0]);
}

void MyGLWidget::modelTransformBracEsquerre2()
{
  glm::mat4 TG(1.0f);
  TG = glm::translate(TG,glm::vec3(0.15,0.15,0.0));
  TG = glm::rotate(TG, glm::radians(120.f), glm::vec3(0,0,1));
