...
public:
    ...
    void setupUi(QWidget *MyForm)
    {
        ...
        QObject::connect(radioButton, SIGNAL(clicked()), widget, SLOT(canviCamara()));
        QObject::connect(verticalSlider, SIGNAL(valueChanged(int)), widget, SLOT(slider(int)));
    ...
    void retranslateUi(QWidget *MyForm)
    {
        ...
        radioButton->setText(QCoreApplication::translate("MyForm", "Camara ", nullptr));
