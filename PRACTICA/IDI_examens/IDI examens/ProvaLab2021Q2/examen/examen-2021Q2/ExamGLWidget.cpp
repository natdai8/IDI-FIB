...
void ExamGLWidget::iniMaterialTronc ()
{
...
void ExamGLWidget::pintaArbre (glm::vec3 pos) 
{
...
void ExamGLWidget::modelTransformTronc (glm::vec3 pos)
{
  TG = glm::mat4(1.f);
...
void ExamGLWidget::modelTransformCopa (glm::vec3 pos)
{
  TG = glm::mat4(1.f);
...
void ExamGLWidget::creaBuffersEsfera ()
{
  // Carreguem el model de l'OBJ - Atenció! Abans de crear els buffers!
